...
@section('title', 'Create New Plan Feature')

@section('content')
<form action="{{ route('admin.plan-features.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow">
    @csrf
    <div class="space-y-4">
        <!-- Name -->
        <div>
    ...
    <div class="mt-6 flex justify-end space-x-4">
        ...
        <button type="submit" class="btn-primary py-2 px-4">Save Plan Feature</button>
    </div>
</form>
@endsection
